...
#define PC_CPU_MODEL_IDS(v) \
    { "qemu32-" TYPE_X86_CPU, "model-id", "AMD Advanced CPU version " v, },\
    { "qemu64-" TYPE_X86_CPU, "model-id", "AMD Advanced CPU version " v, },\
    { "athlon-" TYPE_X86_CPU, "model-id", "AMD Advanced CPU version " v, },
